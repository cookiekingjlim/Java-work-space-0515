...
public class B_Dimension {
	...
	public void method1() {
		 ...
		 * 
		 * */
		for(int i = 0; i < arr.length; i++) { //arr은 3줄이니까
		System.out.println(Arrays.toString(arr[i]));	 //어레이스투스트링 안하면 주소값이 나옴
		}
		...
		for(int i = 0; i < arr.length; i++) {
			for(int j = 0; j < arr[i].length; j++) { //arr의 i값의 길이
