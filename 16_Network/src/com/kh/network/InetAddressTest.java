 ...
 * 
 * 포트(Port)
 * 	- IP 주소는 네트워크 상에서 컴퓨터를 찾을 때만 사용하고 컴퓨터 내에서 실행하는 프로그램을 선택하기 위해 포트를(Port)를 사용
...
public class InetAddressTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("getHostName(): " + ip.getHostName()); 	// 호스트 이름을 반환하는 역할
			System.out.println("getHostAddress(): " + ip.getHostAddress() ); //호스트에 IP 주소를 반환
			System.out.println();
