...
public class Hello { //클래스명은 클래스 파일명과 동일해야 한다. 반드시 지켜야함
	...
	// 실행 메소드 (main 메소드) : 자바 프로그램 실행 시 java.exe에 의해 가장 먼저 호출한다.ㅣ
 ...
 *   = JVM + Java API(경로 lib/src.zip)
 *   
 *   -JVW(Java Virtual Machine) : 자바 가상 머신
 *   
 *   * 자바 프로그램 실행 단계
