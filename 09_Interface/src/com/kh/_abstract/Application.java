 ...
 * - 상속 관계로 구성되어 있으면 다형성 적용이 가능하다	-> 예를 들어 객체 배열로 만들어서 포문으로 출력한 것,,,
 * 
...
//		Sports sport = new Sports();	// <--추상 클래스는 객체 생성 불가, 단 참조 변수형으로는 사용 가능
		...
		Pizza[] pizza = {new BulgogiPizza(32900, "피자헛"),
						new PotatoPizza(27900,"도미노 피자"),
						new PineApplePizza(23000,"피자 알보로")};
		for(Pizza p : pizza) {
			p.makePizza();
		}
