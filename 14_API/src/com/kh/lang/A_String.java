 ...
 * 	- API는 운영체제나 프로그래밍 언어가 제공하는 기능을 제어할 수 있게 만든 인터페이스다
...
//		a.method4();
	...
	public void method1() {
		...
		// toSting() 메서드는 String 클래스에서 오버라이딩되었기때문에 같음
		...
		// equals() 메서드는 String 클래스에서 오버라이딩되었기때문에 같음
		...
		//hashCode() 메서드는 String 클래스에서 오버라이딩되었기때문에 동일함
		...
		//실제 주소값 비교: System.idetityHashCode() - 객체의 고유한 HashCode를 리턴하는 메서드
		System.out.println("str1 : " + System.identityHashCode(str1));	//str1,2 실제 주소값 동일
		System.out.println("str2 : " + System.identityHashCode(str2));
		System.out.println("str3 : " + System.identityHashCode(str3));	//str3,4 실제 주소값 상이
	...
	public void method2() {
		...
		String str3 = str + "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
		System.out.println("str3 : " + str3); // 80이나 83행이나 동일한 것
		...
		index = str.indexOf('?');
		System.out.println("index3: " + index);	// -> 없는 글자이므로 -1 출력
		...
		//8. toCharArray(): char[]
		//	- 문자열의 문자 배열에 담아서 해당 배열의 주소값을 리턴
		char[] arr = str.toCharArray();
		System.out.println(Arrays.toString(arr));
		
		//9. static valueOf([기본 자료형, 문자배열, 객체]): String	<-리턴값
	...
	public void method3() {
		...
		System.out.println("sb1의 문자열 길이: " + sb1.length());	// 문자열이 없으니 0
		System.out.println("sb1의 버퍼의 크기: " + sb1.capacity());	// 기본인 16개
		
		//StringBuilder 클래스의 생성자에 정수값을 전달해주면 해당 크기만큼의 버퍼가 생성
		StringBuilder sb2 = new StringBuilder(30);
		System.out.println("sb2의 문자열 길이: " + sb2.length());
		System.out.println("sb2의 버퍼의 크기: " + sb2.capacity());	//-> 버퍼의 크기를 30으로 바꾸겠다.
		
		//StringBuilder 클래스의 생성자에 문자열을 전달해주면 문자열 크기 + 16 만큼의 버퍼가 생성된다.
		StringBuilder sb3 = new StringBuilder("Hello");
		System.out.println("sb3의 문자열 길이: " + sb3.length());	//5
		System.out.println("sb3의 버퍼의 크기: " + sb3.capacity());	//16+5 -> 21
	...
	public void method4() {
		...
		//상단의 메서드를 이용해서 출력문 IPA avaJ되게끔
		sb2.delete(5, 12);
		sb2.insert(5,"API");
		sb2.reverse();
		System.out.println(sb2);
		
		sb.append("API").delete(4, 12).reverse();
		System.out.println(sb2);
	...
	public void method5() {
		...
		// split(String regex): 입력 받은 구분자로 문자열을 분리해서 문자열의 배열로 담아서 리턴
