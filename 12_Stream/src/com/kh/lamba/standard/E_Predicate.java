...
/*
 * Predicate
 * 	- Predicate 함수적 인터페이스는 매개변수와 boolean 값을 리턴하는 textXXX()로 시작하는 추상 메서드를 가지고 있다.
...
//		e.method2(student1, student2);
	...
	//BiPredicate<T,U>: 객체 T와 U를 비교 조사하는 
	...
	public void method3() {
		IntPredicate ip = i -> i > 100;	// i는 100보다 큰가?
		System.out.println(ip.test(90));	//false
		System.out.println(ip.test(101));	//true
	}
