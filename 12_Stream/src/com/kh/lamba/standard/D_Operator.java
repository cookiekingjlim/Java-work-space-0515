...
/*
 * Operator
 * 	- Operator 함수적 인터페이스는 매개값과 리턴값이 있는 applyXXX()로 시작하는 추상 메서드를 가지고 있다.
...
//		d.method2();
	...
	// IntUnaryOperator: 한 개의 int 연산하는 인터페이스
	public void method2() {
	...
	public void method3() {
		BinaryOperator<Student> bo = (student1, student2) -> student1.getMath() > student2.getMath() ?  student1 : student2;	//수학 점수가 높은 사람을 반환한다.
