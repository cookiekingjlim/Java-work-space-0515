...
/*
 * Supplier
 * 	- Supplier 함수적 인터페이스는 매개변수가 없고 리턴 값이 있는 getXXX()으로 시작하는 추상 메서드를 가지고 있다.
...
//		b.method2();
	...
	// Supplier<T>: T객체를 리턴
	public void method1() {
		Supplier<String> supplier = () ->"Supplier는 제네릭으로 지정된 타입의 객체를 리턴";
	...
	/*
	 * IntSupplier: int값을 리턴 (추상 메서드: int getAsint())
	 * DoubleSupplier: double값을 리턴(추상메서드: double getAsDouble())
	 * LongSupplier: long값을 리턴
	 * */
	public void method3() {
