...
//		c.method2();
	...
	public void method1() {
		...
		students.stream()
				...
				.forEach(name->System.out.println(name));// student 객체에서 이름을 빼오겠ek.
		*/
	...
	//flateMapXXX(): 하나의 요소를 복수의 요소들로 구성된 새로운 스트림을 생성
	public void method2() {
		List<String>list = Arrays.asList("Java11 Lambda","StreamAPI Filtering Sorted Mapping");
		
		list.stream()
					.flatMap(str -> Arrays.stream(str.split(" ")))	//split(" ") 띄어쓰기 구분자
